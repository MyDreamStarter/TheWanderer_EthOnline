...
import type { ISP, ISPInterface } from "../ISP";
...
export class ISP__factory {
  ...
  static createInterface(): ISPInterface {
    return new utils.Interface(_abi) as ISPInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): ISP {
    return new Contract(address, _abi, signerOrProvider) as ISP;
  }
}
